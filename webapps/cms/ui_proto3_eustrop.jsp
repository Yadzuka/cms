...
"-",	"net",	Y,MT_DROPDOWN,	null,	"Net","Сеть","网",null,
 "--",	"upload",Y,MT_CMD,	null,	"upload","загрузить","上载",null,
 "--",	"download",Y,MT_CMD,	null,	"download","скачать","下载",null,
 "--",	"fetch",Y,MT_CMD,	null,	"fetch","сгрузить","取",null,	//!SIC проверить перевод
"-",	"help",	Y,MT_DROPDOWN,	null,	"Help","Справка","咨询室",null,
 "--",	"about",Y,MT_CMD,	null,	"About","О программе","关于系统",null,
